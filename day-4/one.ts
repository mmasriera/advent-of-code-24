...
const hasAdjacentMatch = (
	...
	puzzle[startRow + increaseRow * 2]?.[startCol + increaseCol * 2] ===
		XMAS[2] &&
...
const positionCount = (
	...
	if (hasAdjacentMatch(puzzle, rowIdx, colIdx, 0, 1)) {
		// right
		count += 1;
	}
	...
	if (hasAdjacentMatch(puzzle, rowIdx, colIdx, 1, 0)) {
		// down
		count += 1;
	}
	...
	// check diagonals
	if (hasAdjacentMatch(puzzle, rowIdx, colIdx, 1, 1)) {
		// up-right
		count += 1;
	}
